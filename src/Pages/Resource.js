...
function Resource() {
    return (
        <div className="bg-white">
            <section className="relative bg-gray-900 text-white py-20 px-4 md:px-20 lg:px-40 xl:px-80 bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')]">
                ...
                <div className="container mx-auto">
                    ...
                    <p className="text-lg md:text-xl mb-8">Want to learn something new? Here are all the resources you might need.</p>
                </div>
            </section>
