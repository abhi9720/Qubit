...
function HeroSection() {
    return (
        <div className="bg-gray-900 text-white py-20 bg-cover bg-no-repeat bg-fixed  bg-[url('https://r4.wallpaperflare.com/wallpaper/980/231/735/3840x1080-owdlarrd-panoramic-wallpaper-a1e43a0a20aed542e0422384ce2ef0dd.jpg')] ">
